...
export 'package:eduquest/shared/ui/widgets/ruach_loader.dart' show RuachLoader;
              ...
              child: Container(
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    colors: [RuachColors.gold400, RuachColors.gold600],
                  ),
                ),
              ),
            ),
      ...
      child: Stack(
        ...
        children: [
          ...
          Text(
            ...
            style: Theme.of(
              context,
            ).textTheme.headlineSmall?.copyWith(color: RuachColors.gold400),
          ),
        ],
      ),
    );
      ...
      children: List.generate(7, (i) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            color: done
                ? RuachColors.streakGold
                : (isDark ? RuachColors.ink500 : RuachColors.cream200),
            border: today && !done
                ? Border.all(color: RuachColors.streakGold, width: 2)
                : null,
          ),
          alignment: Alignment.center,
          child: done

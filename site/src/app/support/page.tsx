...
export default async function SupportPage({ searchParams }: Props) {
  ...
  const returnUrl = rawNext.startsWith("eduquest://") ? rawNext : env.appDeepLink;
  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 space-y-6">
      ...
      <section className="grid gap-4 sm:grid-cols-2">
        ...
        <a href={env.supportWhatsApp} target="_blank" rel="noopener noreferrer" className="group rounded-2xl border border-slate-200 bg-white p-5 transition hover:shadow-md hover:border-emerald-200">
